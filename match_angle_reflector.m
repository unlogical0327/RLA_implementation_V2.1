...
length(Reflect_angle_vector);
length(detect_Ref_angle_vector);
match_angle_flag

if  m>=3
    matched_reflect_ID=unique(matched_reflect_angle_ID,'stable')';
    matched_detect_ID=unique(matched_detect_angle_ID,'stable')';
